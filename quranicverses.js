...
async function addToBookmarks(surahName, surahNo, ayatNo) {
    var surahNames = ["سورَةُ الكَوثَر", "سورَةُ العَصْر", "سورَةُ النـَّصر", "سورَةُ قـُرَيْش", "سورَةُ الفَاتِحَة", "سورَةُ القـَدر","سورَةُ الفَلَق","سورَةُ الفِيل","سورَةُ المَسَد","سورَةُ الإخْلَاص","سورَةُ الكَافِرُون"," سورَةُ النَّاس"];
    try {
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("signupbtn").addEventListener("click", function() {
        ...
        document.getElementById("logomade").style.display = "none";
        ...
        xhr.onreadystatechange = function() {
            ...
            if (xhr.readyState === 4) {
                ...
                if (xhr.status === 200) {
                    ...
                    resolve(parsedResponse.userno); // Resolve the promise with the user number
                } else {
